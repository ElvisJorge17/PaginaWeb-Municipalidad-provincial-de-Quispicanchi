...
import dataconvoc from "../../../jsons/ActividadesOficiales.json";
...
const ActividadesOficiales=()=>{
   ...
   return(
         <>
         <h1 className="tituloPestañas contenedorTitulo">Actividades Oficiales</h1>
...
export default ActividadesOficiales;
