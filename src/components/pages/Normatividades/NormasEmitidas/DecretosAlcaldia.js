...
import dataconvoc from "../../../jsons/DecretosAlcaldia.json";
import enlapdf from "../../../../../src/images/imgconvocatoria/PDF-V.png"
import "../../../Style/estilosgenerales.css"
import Footer from "../../../Footer";
const DecretosAlcaldia=()=>{
   const [contacts, setContact]=useState(dataconvoc);
   return(
         <>
         <h1 className="tituloPestañas contenedorTitulo">Decretos de alcaldía</h1>
...
export default DecretosAlcaldia;
